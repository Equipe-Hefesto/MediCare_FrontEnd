...
export default function TelaInicial() {
  ...
  useEffect(() => {
    const fetchRoles = async () => {
      ...
      // decoded.unique_name pode ser string ou array, garante string
      const userRoles = Array.isArray(decoded.unique_name)
        ? decoded.unique_name.join(", ")
        : decoded.unique_name || "";
    ...
    <View style={styles.containerPai}>
      ...
      <View style={styles.containerUsuario}>
        <View style={styles.bemVindoUsuario}>
          ...
          <Text id="usuario" style={styles.usuario}>
            {username}
          </Text>
        </View>
      ...
      <TouchableOpacity
        activeOpacity={0.8}
        style={styles.containerBotao}
        onPress={() => router.replace("./Remedio")}
      >
        <View style={styles.iconeBotao}>
      ...
      <View style={styles.menuInferior}>
        <MenuInferior cor1={"#ACE1F5"} cor2={"#fff"} cor3={"#fff"} cor4={"#fff"} />
      </View>
    </View>
  );
}